...
//protected:
   ...
   */
  void csn_LOW(int mode);
  void csn_HIGH(int mode);
  /**
   * Set chip enable
   *
   ...
   */
  uint8_t read_register_multiple(uint8_t reg, uint8_t* buf, uint8_t len);
   ...
   * @return Current value of status register
   */
  uint8_t write_register_multiple(uint8_t reg, const uint8_t* buf, uint8_t len);
